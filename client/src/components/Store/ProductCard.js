...
const ProductCard = ({ product }) => {
  return (
    <article className="itemContainer product">
      ...
      <div className="sizes">
        <div
          className={product.sizes.includes("s") ? "talle habilitado" : "talle"}
        >
          s
        </div>
        <div
          className={product.sizes.includes("m") ? "talle habilitado" : "talle"}
        >
          m
        </div>
        <div
          className={product.sizes.includes("l") ? "talle habilitado" : "talle"}
        >
          l
        </div>
        <div
